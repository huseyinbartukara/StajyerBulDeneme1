...
class MainFragment : Fragment() {
    ...
    private lateinit var StajIlanAdapter : StajIlanAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        tasarim.toolbarMain.title = ""
        (activity as AppCompatActivity).setSupportActionBar(tasarim.toolbarMain)


        getData()

        tasarim.rvMain.layoutManager = LinearLayoutManager(requireActivity())
        StajIlanAdapter = StajIlanAdapter(stajIlanArrayList)
        tasarim.rvMain.adapter = StajIlanAdapter
                            ...
                            if(error != null){
                                ...
                                if(value != null){
                                    if(!value.isEmpty){
                                        ...
                                        StajIlanAdapter.notifyDataSetChanged()
                                    }
                                }
                            }
                        }
